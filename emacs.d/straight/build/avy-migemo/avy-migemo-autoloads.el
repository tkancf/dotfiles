...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "avy-migemo" '("avy-m")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "avy-migemo-e.g.counsel" '("counsel-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "avy-migemo-e.g.ivy" '("ivy-" "avy-migemo--ivy--regex-hash")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "avy-migemo-e.g.swiper" '("swiper-")))
